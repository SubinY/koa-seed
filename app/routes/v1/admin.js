...
// 创建用户
router.linPost('createUser', '/create', router.permission('admin_createUser', '创建用户'), adminDAO.create);

// 删除用户
router.linDelete('deleteUser', '/delete:id', router.permission('admin_deleteUser', '删除用户'), adminDAO.delete);

// 更新用户
router.linPut('updateUser', '/update', router.permission('admin_updateUser', '更新用户'), adminDAO.update);

// 查看用户
router.linGet('getDetail', '/detail/:id', router.permission('admin_getDetail', '用户详情'), adminDAO.detail);

// 登录
router.linPost('userLogin', '/login', loginDAO.login);
